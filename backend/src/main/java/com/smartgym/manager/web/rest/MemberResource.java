...
/**
 * REST controller for managing {@link com.smartgym.manager.domain.Member}.
 */
...
public class MemberResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<MemberDTO>> getAllMembers(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
