...
import { CheckInService, EntityArrayResponseType } from '../service/check-in.service';
...
export class CheckInComponent implements OnInit {
  ...
  trackId = (item: ICheckIn): number => this.checkInService.getCheckInIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.checkIns.set(dataFromBody);
  }
