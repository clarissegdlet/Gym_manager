...
import { sampleWithRequiredData } from '../coach.test-samples';
...
describe('Coach Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.coaches()[0]).toEqual(expect.objectContaining({ id: 24583 }));
  });

  describe('trackId', () => {
    it('should forward to coachService', () => {
      const entity = { id: 24583 };
      jest.spyOn(service, 'getCoachIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCoachIdentifier).toHaveBeenCalledWith(entity);
